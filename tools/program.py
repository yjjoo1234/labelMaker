...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        # Recognition Model  
        # self.add_argument("-c", "--config", default='config/rec/ko_ocrv3_rec.yml', help="configuration file to use") 

        # Detection Model 
        # self.add_argument("-c", "--config", default='config/det/ko_ocrv3_det.yml', help="configuration file to use") 

        # VQA Model 
        self.add_argument("-c", "--config", default='config/vqa/vi_layoutxlm.yml', help="configuration file to use") 
        self.add_argument("-o", "--opt", nargs='+', help="set configuration options")
        self.add_argument('-p','--profiler_options', type=str, default=None,
